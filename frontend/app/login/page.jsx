...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 flex items-center justify-center p-4">
      ...
      <Card className="w-full max-w-md border-4 border-gray-700 bg-gray-800 text-white shadow-[0_0_20px_rgba(255,0,0,0.2)] pixel-border">
        <CardHeader>
          <CardTitle className="text-2xl text-center pixel-font">LOGIN</CardTitle>
          <CardDescription className="text-center text-gray-400">Enter your credentials to continue</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button
              type="submit"
              className="w-full h-12 bg-red-600 hover:bg-red-700 mt-4 pixel-button"
              disabled={isLoading}
            >
              {isLoading ? (
                <>
